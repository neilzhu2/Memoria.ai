import svgPaths from "./svg-pt9oafvqya";
    ...
    >
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[90px] py-0 relative w-full">
          <div
            className="font-['Shantell_Sans:Bold',_sans-serif] font-bold leading-[0] relative shrink-0 text-[#000000] text-[11px] text-center text-nowrap"
            style={{ fontVariationSettings: "'BNCE' 0, 'INFM' 0, 'SPAC' 0" }}
          >
...
function DeleteMemoryContainer() {
  return (
    <div
