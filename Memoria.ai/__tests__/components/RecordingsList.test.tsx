...
describe('RecordingsList - Audio Playback Feature', () => {
  ...
  beforeEach(() => {
    ...
    // Setup expo-av mock
    (mockAudio.Sound.createAsync as jest.Mock) = jest.fn(() =>
  ...
  describe('3. Skip Controls (Rewind/Forward 15s)', () => {
    ...
    it('rewinds 15 seconds when rewind button is pressed', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockResolvedValue({ sound: mockSound });
  ...
  describe('5. Multiple Audio Management', () => {
    it('stops currently playing audio when new audio starts', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockResolvedValueOnce({ sound: secondMockSound });
    ...
    it('cleans up previous audio resources properly', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockResolvedValueOnce({ sound: newMockSound });
  ...
  describe('7. Error Handling', () => {
    it('shows error alert when audio file is missing', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockRejectedValueOnce(
  ...
  describe('10. Edge Cases', () => {
    it('handles very short audio files (< 15s)', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockResolvedValueOnce({ sound: shortMockSound });
    ...
    it('handles very long audio files (> 1 hour)', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockResolvedValueOnce({ sound: longMockSound });
    ...
    it('handles audio with zero duration gracefully', async () => {
      ...
      (mockAudio.Sound.createAsync as jest.Mock).mockResolvedValueOnce({ sound: zeroMockSound });
